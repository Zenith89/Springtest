...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
/*Default behavior of Spring Data repositories is to run each method call
 in a transaction. By marking the service method as transactional,
  we pull the transaction boundaries to the service method,
